vi.mock("abap-adt-api", () => ({
  isDebuggerBreakpoint: vi.fn(function (bp: any) { return bp && bp.__isDebuggerBP === true })
}))
vi.mock("abapfs", () => ({
  isAbapFile: vi.fn(function (node: any) { return node && node.__isAbapFile === true })
}))
vi.mock(
  "vscode",
  () => ({
...
vi.mock("@vscode/debugadapter", () => ({
  Breakpoint: vi.fn().mockImplementation(function (verified: boolean, line?: number) { return ({
      verified,
      line
    }) }),
...
vi.mock("../../lib", () => ({
  ...
  ignore: vi.fn(),
  isDefined: vi.fn(function (x: any) { return x !== undefined && x !== null }),
  log: vi.fn()
}))
vi.mock("../conections", () => ({
  getClient: vi.fn(),
...
function makeAbapNode(overrides: Partial<any> = {}) {
  return {
    ...
    object: {
      structure: {},
      contentsPath: vi.fn(function () { return "/sap/bc/adt/programs/programs/ZPROG" }),
  ...
  describe("include breakpoint URI handling", () => {
    test("builds VIT URI for includes (with mainPrograms)", async () => {
      ...
      const node = makeAbapNode({
        object: {
          structure: {},
          contentsPath: vi.fn(function () { return "/sap/bc/adt/programs/includes/ZINCLUDE" }),
          loadStructure: vi.fn().mockResolvedValue(undefined),
