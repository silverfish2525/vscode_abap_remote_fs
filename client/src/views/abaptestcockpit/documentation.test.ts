vi.mock(
  ...
  () => ({
    ...
    Uri: {
      parse: vi.fn(function (s: string) { return ({ toString: () => s, scheme: "adt" }) })
    },
    CancellationToken: {},
    WebviewView: {},
...
vi.mock("../history", () => ({
  History: vi.fn().mockImplementation(function (initial?: any) {
      ...
      return {
        ...
        append: vi.fn(function (item: any) {
...
vi.mock("../utilities", () => ({
  injectUrlHandler: vi.fn(function (html: string) { return `<injected>${html}</injected>` })
}))
