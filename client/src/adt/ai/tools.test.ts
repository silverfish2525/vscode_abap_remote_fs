...
vi.mock("./search", () => ({
  SearchTool: vi.fn().mockImplementation(function () { return ({ id: "search" }) })
}))

vi.mock("./unit", () => ({
  UnitTool: vi.fn().mockImplementation(function () { return ({ id: "unit" }) })
}))

vi.mock("./activate", () => ({
  ActivateTool: vi.fn().mockImplementation(function () { return ({ id: "activate" }) })
}))
