vi.mock("vscode", () => ({
  ...
  tests: {
    createTestController: vi.fn().mockReturnValue({
      ...
      createTestItem: vi.fn().mockImplementation(function (id: string, label: string) { return ({
              id,
              label,
              children: {
                get: vi.fn(),
  ...
  TestRunRequest: vi.fn().mockImplementation(function (include: any) { return ({ include, exclude: [] }) }),
  TestMessage: vi.fn().mockImplementation(function (msg: any) { return ({ message: msg }) }),
  MarkdownString: vi.fn().mockImplementation(function (s: string) { return ({ value: s }) }),
...
vi.mock("abap-adt-api", () => ({
  ...
  uriPartsToString: vi.fn(function (u: any) { return u?.toString() || "" })
}))

vi.mock("../../lib", () => ({
  lineRange: vi.fn(function (line: number) { return ({ start: { line }, end: { line } }) })
}))
...
vi.mock("./AdtObjectFinder", () => ({
  AdtObjectFinder: vi.fn().mockImplementation(function () { return ({
