const { mockRegisterCommand, mockOnWillSaveTextDocument, mockOnDidChangeConfiguration, mockExecuteCommand, mockShowInformationMessage, mockShowWarningMessage } = vi.hoisted(() => {
  ...
  return { mockRegisterCommand, mockOnWillSaveTextDocument, mockOnDidChangeConfiguration, mockExecuteCommand, mockShowInformationMessage, mockShowWarningMessage }
})
vi.mock(
  "vscode",
  () => ({
