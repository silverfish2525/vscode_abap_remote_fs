vi.mock("vscode", () => ({
  Uri: {
    parse: vi.fn(function (s: string) { return ({ scheme: "adt", path: "/path", toString: () => s }) })
  },
...
vi.mock("abapfs", () => ({
  ...
  isAbapStat: vi.fn().mockImplementation(function (x: any) { return x != null && typeof x === "object" && x.object != null }),
...
vi.mock("abap-adt-api", () => ({
  ...
  objectPath: vi.fn(function (type: string, name?: string, parent?: string) { return `/sap/bc/adt/${type}/${name}` }),
...
vi.mock("fp-ts/lib/pipeable", () => ({ pipe: vi.fn(function (v: any) { return v }) }))
...
describe("AdtObjectCreator", () => {
  ...
  beforeEach(() => {
    ...
    ;(isAbapStat as Mock).mockImplementation(function (x: any) { return x != null && typeof x === "object" && x.object != null })
