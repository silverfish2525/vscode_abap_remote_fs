...
vi.mock("fp-ts/lib/Option", () => ({
  some: vi.fn(function (v: any) { return ({ _tag: "Some", value: v }) }),
  fromEither: vi.fn(function (e: any) { return e }),
  isSome: vi.fn(function (v: any) { return v?._tag === "Some" }),
  Option: {}
}))
...
describe("dataCredentials", () => {
  ...
  it("returns stored credentials if already set with password", async () => {
    ...
    ;(some as Mock).mockImplementation(function (v: any) { return ({ _tag: "Some", value: v }) })
