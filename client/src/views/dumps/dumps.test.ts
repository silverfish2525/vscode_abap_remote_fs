...
vi.mock("../../commands", () => ({
  ...
  command: vi.fn(function (name: string) { return (_target: any, _key: string, descriptor: PropertyDescriptor) => descriptor })
}))

vi.mock("../../config", () => ({
  connectedRoots: vi.fn(function () { return new Map([["DEV100", {}]]) })
}))
