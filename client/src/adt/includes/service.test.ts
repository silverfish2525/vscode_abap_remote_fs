...
vi.mock("../../lib", () => ({
  cache: vi.fn(function (fn: any) { return ({ get: fn }) }),
  log: vi.fn()
}))
vi.mock("../conections", () => ({
  getRoot: vi.fn()
...
const mockRoot = {
  getNode: vi.fn(),
  getNodeAsync: vi.fn(),
  getNodePath: vi.fn(function () { return [] })
}
...
describe("IncludeService", () => {
  ...
  describe("guessParent", () => {
    ...
    it("returns parent from node path when available", () => {
      ...
      mockIsAbapStat.mockImplementation(function (f: any) { return f === parentStat })
      mockRoot.getNodePath.mockReturnValue([
        { file: {} },
        { file: parentStat }
      ] as any)
    ...
    it("skips DEVC/K (package) parents", () => {
      ...
      mockIsAbapStat.mockImplementation(function (f: any) { return f === pkgStat })
      mockRoot.getNodePath.mockReturnValue([
        { file: {} },
        { file: pkgStat }
      ] as any)
