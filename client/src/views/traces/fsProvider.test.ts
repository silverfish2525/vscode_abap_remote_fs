...
// Top-level mocks are hoisted, making this a normal static import.
import { ADTPROFILE, adtProfileUri } from "./fsProvider"
...
const registeredScheme = registerCall?.[0] as string | undefined
const traceFs = registerCall?.[1] as any
