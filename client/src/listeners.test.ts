...
vi.mock("vscode", () => ({
  ...
  Uri: {
    parse: vi.fn(function (s) { return ({ toString: () => s, scheme: "adt", authority: "host", path: "/file" }) })
  },
  TabInputTextDiff: class {}
}))

vi.mock("./lib", () => ({
  caughtToString: vi.fn(function (e) { return String(e) }),
  debounce: vi.fn(function (delay: number, fn: Function) { return fn }),
  log: vi.fn(),
  viewableObjecttypes: []
}))
vi.mock("./adt/conections", () => ({
  ADTSCHEME: "adt",
  uriRoot: vi.fn(),
  abapUri: vi.fn(function () { return false }),
  getRoot: vi.fn()
}))
vi.mock("abapobject", () => ({}))
...
vi.mock("./fs/LocalFsProvider", () => ({ LocalFsProvider: { useLocalStorage: vi.fn(function () { return false }) } }))
